...
public class DlgBilingRalan extends javax.swing.JDialog {
    ...
    private double ttl=0,y=0,subttl=0,ralanparamedis=0,piutang=0,itembayar=0,itempiutang=0, 
                   ...
                   Jasa_Medik_Dokter_Operasi_Ralan=0,Jasa_Medik_Paramedis_Operasi_Ralan=0,Obat_Operasi_Ralan=0,uangdeposit=0,kekurangan=0;
    ...
    private String nota_jalan="",dokterrujukan="",polirujukan="",umur="",status="",biaya="",tambahan="",totals="",kdptg="",nmptg="",kd_pj="",notaralan="",centangdokterralan="",
            ...
            Operasi_Ralan="",tampilkan_ppnobat_ralan="",rincianoperasi="",Uang_Muka_Ralan="",centangobatralan="No",
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DLgBilingRalan")){
                    if(status.equals("belum")){
                        ...
                        uangdeposit=Sequel.cariIsiAngka("select ifnull(sum(Uang_Muka),0) from nota_jalan where no_rawat=?",TNoRw.getText());
                    }
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-05-2021 20:06:00" }));
...
//                    Sequel.queryu2("truncate table temporary_bayar_ralan");
...
//                        Sequel.menyimpan("temporary_bayar_ralan","'0','DEPOSIT',':','','','','','<b>"+Deposit.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter");
//                    }else if(piutang>0){                                                   
//                        Sequel.menyimpan("temporary_bayar_ralan","'0','TOTAL TAGIHAN',':','','','','','"+TtlSemua.getText()+"','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
//                        Sequel.menyimpan("temporary_bayar_ralan","'0','PPN',':','','','','','"+Valid.SetAngka(besarppn)+"','Tagihan','"+akses.getkode()+"','','','','','','','',''","Tagihan"); 
...
//                    }
                ...
                if(piutang<=0){                        
                    Sequel.menyimpan("temporary_bayar_ralan","'0','','','','','','','','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','TOTAL TAGIHAN',':','','','','','<b>"+TtlSemua.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','PPN',':','','','','','<b>"+Valid.SetAngka(besarppn)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','TAGIHAN+PPN',':','','','','','<b>"+TagihanPPn.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','','','','','','','','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','DEPOSIT',':','','','','','<b>"+Deposit.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','BAYAR',':','','','','','<b>"+Valid.SetAngka(bayar)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','KEMBALI',':','','','','','<b>"+TKembali.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                }else if(piutang>0){                                            
                    Sequel.menyimpan("temporary_bayar_ralan","'0','','','','','','','','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','TOTAL TAGIHAN',':','','','','','<b>"+TtlSemua.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','PPN',':','','','','','<b>"+Valid.SetAngka(besarppn)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    ...
                    Sequel.menyimpan("temporary_bayar_ralan","'0','','','','','','','','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','DEPOSIT',':','','','','','<b>"+Deposit.getText()+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','EKSES',':','','','','','<b>"+Valid.SetAngka(bayar)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ralan","'0','SISA PIUTANG',':','','','','','<b>"+Valid.SetAngka(piutang)+"</b>','Tagihan','"+akses.getkode()+"','','','','','','','',''","Rekap Harian Tindakan Dokter");                                      
                }
	...
	try{
        ...
        if(i>0){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));            
             ...
             if(uangdeposit>0){
                Sequel.menyimpan("tampjurnal","'"+Uang_Muka_Ralan+"','Kontra Akun Uang Muka','0','"+uangdeposit+"'","kredit=kredit+"+uangdeposit,"kd_rek='"+Uang_Muka_Ralan+"'");    
             }
        ...
        if((chkLaborat.isSelected()==false)||(chkRadiologi.isSelected()==false)){
            ...
            try {
                ...
                try {                                       
                    ...
                    psnota.setDouble(20,uangdeposit);
...
//                                        Sequel.menyimpan("tampjurnal","'"+tbAkunBayar.getValueAt(r,1).toString()+"','"+tbAkunBayar.getValueAt(r,0).toString()+"','"+Double.toString(total)+"','0'","Rekening");
                ...
                if(uangdeposit>0){  
                    Sequel.menyimpan("tampjurnal","'"+Uang_Muka_Ralan+"','Kontra Akun Uang Muka','"+uangdeposit+"','0'","debet=debet+"+uangdeposit,"kd_rek='"+Uang_Muka_Ralan+"'"); 
                }
