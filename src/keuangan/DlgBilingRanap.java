        ...
        if(norawatubahlama.getText().trim().equals("")||(tbUbahLama.getRowCount()<=0)){
            ...
            for(int r=0;r<tbUbahLama.getRowCount();r++){
                if(Valid.SetAngka(tbUbahLama.getValueAt(r,6).toString())>-1){                    
                    Sequel.mengedit("kamar_inap","no_rawat='"+norawatubahlama.getText()+"' and kd_kamar='"+tbUbahLama.getValueAt(r,0)+"' and tgl_masuk='"+tbUbahLama.getValueAt(r,2).toString()+"'",
                           "jam_keluar='"+tbUbahLama.getValueAt(r,5).toString()+"',"+
                           "tgl_keluar='"+tbUbahLama.getValueAt(r,4).toString()+"',jam_masuk='"+tbUbahLama.getValueAt(r,3).toString()+"',"+
