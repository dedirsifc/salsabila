...
public class DlgDetailTambahan extends javax.swing.JDialog {
    ...
    public DlgDetailTambahan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Tanggal","No Rawat","Ruangan","Jaminan","Nama Pasien","Nama Tambahan","Besar Tambahan"};
        ...
        try {
            ...
            pspasien=koneksi.prepareStatement("select if(reg_periksa.status_lanjut='Ralan',\n" +
                    "(select nm_poli from poliklinik where poliklinik.kd_poli=reg_periksa.kd_poli),\n" +
                    "(select bangsal.nm_bangsal \n" +
                    "from kamar_inap inner join kamar inner join bangsal on kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.no_rawat=reg_periksa.no_rawat order by tgl_keluar desc limit 1 )) AS ruangan, reg_periksa.no_rawat,pasien.nm_pasien,penjab.png_jawab from reg_periksa inner join pasien inner join penjab "+
                    "on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj where reg_periksa.no_rawat in (select no_rawat from tambahan_biaya) and "+
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptRTambahan.jasper","report","[ Rekap Tambahan Biaya ]",param);
            ...
            while(rs.next()){
                ...
                while(rspasien.next()){                    
                    ...
                    while(rstambahan.next()){
                        if(a==1){
                            tabMode.addRow(new Object[]{"","",rspasien.getString("no_rawat"),rspasien.getString("ruangan"),rspasien.getString("png_jawab"),rspasien.getString("nm_pasien"),rstambahan.getString("nama_biaya"),rstambahan.getDouble("besar_biaya")});
                        }else{
