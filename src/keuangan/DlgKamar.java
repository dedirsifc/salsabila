...
public final class DlgKamar extends javax.swing.JDialog {
    ...
    public DlgKamar(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{
                "P","Nomer Bed","Kode Kamar","Nama Kamar","Kelas","Tarif Kamar","Status Kamar","Bayangan"
            }){
        ...
        tbKamar.getTableHeader().setEnabled(false);
    ...
    public void tampil() {
        ...
        try{     
            ps=koneksi.prepareStatement("select kamar.kd_kamar,kamar.kd_bangsal,bangsal.nm_bangsal, "+
                       ...
                       "if(bangsal.kd_bangsal LIKE '%BBBB%',(SELECT concat(count(nm_bangsal),'Bayangan') from bangsal where bangsal.kd_bangsal=kamar.kd_bangsal), "+
                       "(SELECT concat(count(nm_bangsal),'Real') from bangsal where bangsal.kd_bangsal=kamar.kd_bangsal)) AS bayangan from bangsal inner join kamar "+
                       ...
                       "order by kamar.kd_kamar,bangsal.nm_bangsal,kamar.kelas ASC");
            try {                
                ...
                rs=ps.executeQuery();
                while(rs.next()){
                    String isBayang = "1Bayangan";
                    if (!rs.getString("bayangan").contains("1Bayangan")) {
                        isBayang = "1Real";
                    }
    ...
    private static JTable getNewRenderedTable(final JTable table) {
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table,
                ...
                if (col == 7) {
                    if ("1Bayangan".equalsIgnoreCase(status)) {
                    ...
                    comp.setBackground(new Color(255,246,244));
                    comp.setForeground(Color.black);
                }
                return comp;
            }
