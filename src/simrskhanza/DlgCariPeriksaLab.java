...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakLab1 = new javax.swing.JMenu();
        MnCetakHasilSwabN = new javax.swing.JMenuItem();
        MnCetakHasilSwabP = new javax.swing.JMenuItem();
        ...
        MnCetakLab1.setBackground(new java.awt.Color(250, 255, 245));
        MnCetakLab1.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakLab1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakLab1.setText("Cetak SWAB");
        MnCetakLab1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakLab1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakLab1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakLab1.setName("MnCetakLab1"); // NOI18N
        MnCetakLab1.setPreferredSize(new java.awt.Dimension(160, 26));

        MnCetakHasilSwabN.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilSwabN.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilSwabN.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilSwabN.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilSwabN.setText("Swab N Completed");
        MnCetakHasilSwabN.setName("MnCetakHasilSwabN"); // NOI18N
        MnCetakHasilSwabN.setPreferredSize(new java.awt.Dimension(160, 26));
        MnCetakHasilSwabN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilSwabNActionPerformed(evt);
            }
        });
        MnCetakLab1.add(MnCetakHasilSwabN);

        MnCetakHasilSwabP.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilSwabP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilSwabP.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilSwabP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilSwabP.setText("Swab P Completed");
        MnCetakHasilSwabP.setName("MnCetakHasilSwabP"); // NOI18N
        MnCetakHasilSwabP.setPreferredSize(new java.awt.Dimension(160, 26));
        MnCetakHasilSwabP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilSwabPActionPerformed(evt);
            }
        });
        MnCetakLab1.add(MnCetakHasilSwabP);

        jPopupMenu1.add(MnCetakLab1);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
    ...
    private void MnCetakHasilSwabNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilSwabNActionPerformed
        // TODO add your handling code here:
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabPermintaanN.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            } else {
                                Valid.MyReport("rptPeriksaLab.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            }
                        } catch (Exception e) {
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilSwabNActionPerformed

    private void MnCetakHasilSwabPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilSwabPActionPerformed
        // TODO add your handling code here:
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabPermintaanP.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            } else {
                                Valid.MyReport("rptPeriksaLab.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            }
                        } catch (Exception e) {
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilSwabPActionPerformed
    ...
    private javax.swing.JMenuItem MnCetakHasilSwabN;
    private javax.swing.JMenuItem MnCetakHasilSwabP;
    private javax.swing.JMenu MnCetakLab;
    private javax.swing.JMenu MnCetakLab1;
