...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppCatatanKamar = new javax.swing.JMenuItem();
        ...
        ppCatatanKamar.setBackground(new java.awt.Color(255, 255, 254));
        ppCatatanKamar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCatatanKamar.setForeground(new java.awt.Color(50, 50, 50));
        ppCatatanKamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppCatatanKamar.setText("Catatan Status Kamar Pasien");
        ppCatatanKamar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCatatanKamar.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCatatanKamar.setName("ppCatatanKamar"); // NOI18N
        ppCatatanKamar.setPreferredSize(new java.awt.Dimension(200, 26));
        ppCatatanKamar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCatatanKamarBtnPrintActionPerformed(evt);
            }
        });
        MenuInputData.add(ppCatatanKamar);
        ...
        LabelCatatan.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        LabelCatatan.setColumns(20);
        LabelCatatan.setForeground(new java.awt.Color(255, 255, 255));
        LabelCatatan.setRows(5);
        LabelCatatan.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        LabelCatatan.setName("LabelCatatan"); // NOI18N
        internalFrame10.add(LabelCatatan);
        LabelCatatan.setBounds(30, 70, 210, 100);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-06-2021" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-06-2021" }));
    ...
    private void tbKamInMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKamInMouseClicked
        if (tabMode.getRowCount() != 0) {
            ...
            if (i == 7) {                   
                        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                        LabelCatatan.setText(Sequel.cariIsi("select is_catat from catatan_kamar where no_rawat=?", TNoRw1.getText()));
                        TPasien2.setText(Sequel.cariIsi("select pasien.nm_pasien from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.no_rawat=?", TNoRw1.getText()));
                        if (!LabelCatatan.getText().equals("")) {
                            DlgCatatan.setSize(400, 200);
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
    ...
    private void ppCatatanKamarBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCatatanKamarBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data pasien sudah habis...!!!!");
            TCari.requestFocus();
        } else if (tbKamIn.getSelectedRow() == -1) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgCatatanKamar catatanKamar = new DlgCatatanKamar(null, true);
            catatanKamar.setNoRwt(tbKamIn.getValueAt(tbKamIn.getSelectedRow(), 0).toString());
            catatanKamar.setSize(720, 330);
            catatanKamar.setLocationRelativeTo(internalFrame1);
            catatanKamar.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_ppCatatanKamarBtnPrintActionPerformed
    ...
    private javax.swing.JMenuItem ppCatatanKamar;
