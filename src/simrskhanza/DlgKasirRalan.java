...
import rekammedis.RMpemeriksaanMCUdokter;
import rekammedis.RMMedicalcekup;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PemeriksaanMCU = new javax.swing.JMenu();
        PemeriksaanPetugas = new javax.swing.JMenuItem();
        PemeriksaanDokter = new javax.swing.JMenuItem();
        ...
        PemeriksaanMCU.setBackground(new java.awt.Color(250, 255, 245));
        PemeriksaanMCU.setForeground(new java.awt.Color(50, 50, 50));
        PemeriksaanMCU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        PemeriksaanMCU.setText("Pemeriksaan MCU");
        PemeriksaanMCU.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PemeriksaanMCU.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        PemeriksaanMCU.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        PemeriksaanMCU.setName("PemeriksaanMCU"); // NOI18N
        PemeriksaanMCU.setPreferredSize(new java.awt.Dimension(160, 26));

        PemeriksaanPetugas.setBackground(new java.awt.Color(255, 255, 254));
        PemeriksaanPetugas.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PemeriksaanPetugas.setForeground(new java.awt.Color(50, 50, 50));
        PemeriksaanPetugas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        PemeriksaanPetugas.setText("Pemeriksaan Petugas");
        PemeriksaanPetugas.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        PemeriksaanPetugas.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        PemeriksaanPetugas.setName("PemeriksaanPetugas"); // NOI18N
        PemeriksaanPetugas.setPreferredSize(new java.awt.Dimension(260, 26));
        PemeriksaanPetugas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PemeriksaanPetugasActionPerformed(evt);
            }
        });
        PemeriksaanMCU.add(PemeriksaanPetugas);

        PemeriksaanDokter.setBackground(new java.awt.Color(255, 255, 254));
        PemeriksaanDokter.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PemeriksaanDokter.setForeground(new java.awt.Color(50, 50, 50));
        PemeriksaanDokter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        PemeriksaanDokter.setText("Pemeriksaan Dokter");
        PemeriksaanDokter.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        PemeriksaanDokter.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        PemeriksaanDokter.setName("PemeriksaanDokter"); // NOI18N
        PemeriksaanDokter.setPreferredSize(new java.awt.Dimension(260, 26));
        PemeriksaanDokter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PemeriksaanDokterActionPerformed(evt);
            }
        });
        PemeriksaanMCU.add(PemeriksaanDokter);

        MnDataRM.add(PemeriksaanMCU);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2021" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2021" }));
...
//                    DlgEResepDokter resep = new DlgEResepDokter(null, false);
        ...
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?", TNoRw.getText()) > 0) {
                    ...
                    DlgDeposit form = new DlgDeposit(null, false);
                    form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
                    form.setLocationRelativeTo(internalFrame1);
    ...
    private void PemeriksaanPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PemeriksaanPetugasActionPerformed
        // TODO add your handling code here:
         if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data registrasi sudah habis...!!!!");
            TNoRM.requestFocus();
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMpemeriksaanMCUdokter form = new RMpemeriksaanMCUdokter(null, false);
                form.isCek();
                form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
                form.setLocationRelativeTo(internalFrame1);
                form.emptTeks();
    ...
    }//GEN-LAST:event_PemeriksaanPetugasActionPerformed

    private void PemeriksaanDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PemeriksaanDokterActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PemeriksaanDokterActionPerformed
    ...
    private javax.swing.JMenuItem PemeriksaanDokter;
    private javax.swing.JMenu PemeriksaanMCU;
    private javax.swing.JMenuItem PemeriksaanPetugas;
