...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cetak_cppt = new javax.swing.JMenuItem();
        ...
        cetak_cppt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PrinterSettings.png"))); // NOI18N
        cetak_cppt.setText("Cetak CPPT");
        cetak_cppt.setToolTipText("");
        cetak_cppt.setName("cetak_cppt"); // NOI18N
        cetak_cppt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cetak_cpptActionPerformed(evt);
            }
        });
        jPopupMenu1.add(cetak_cppt);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-08-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-08-2021" }));
        ...
        tbPemeriksaan.getAccessibleContext().setAccessibleParent(null);
        ...
        jLabel15.setBounds(720, 10, 40, 23);
        ...
        TAlergi.setBounds(770, 10, 135, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-08-2021" }));
                ...
                case 3:
                    if((!TKeluhan.getText().trim().equals(""))||(!TPemeriksaan.getText().trim().equals(""))||
                        ...
                        if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",17,new String[]{
                            ...
                            cmbImun.getSelectedItem().toString(),TindakLanjut.getText(),TPenilaian.getText(),"admin"})==true){
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void cetak_cpptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetak_cpptActionPerformed
        ...
        if (tabModePemeriksaan.getRowCount() == 0) {
            ...
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            param.put("tgl_cppt", Sequel.cariIsi("SELECT CONCAT (date_format(tgl_perawatan,'%d-%m-%Y'),' ',jam_rawat) as tgl_cppt FROM pemeriksaan_ralan where no_rawat=? order by pemeriksaan_ralan.jam_rawat desc", TNoRw.getText()));
            param.put("keluhan", Sequel.cariIsi("SELECT keluhan FROM pemeriksaan_ralan where no_rawat=? order by pemeriksaan_ralan.jam_rawat desc", TNoRw.getText()));
            param.put("pemeriksaan", Sequel.cariIsi("SELECT pemeriksaan FROM pemeriksaan_ralan where no_rawat=? order by pemeriksaan_ralan.jam_rawat desc", TNoRw.getText()));
            param.put("penilaian", Sequel.cariIsi("SELECT penilaian FROM pemeriksaan_ralan where no_rawat=? order by pemeriksaan_ralan.jam_rawat desc", TNoRw.getText()));
            param.put("rtl", Sequel.cariIsi("SELECT rtl FROM pemeriksaan_ralan where no_rawat=? order by pemeriksaan_ralan.jam_rawat desc", TNoRw.getText()));
            param.put("barcode", Sequel.cariIsi("SELECT dr.nm_dokter as barcode FROM pemeriksaan_ralan pr LEFT JOIN dokter dr ON pr.created_by=dr.kd_dokter where no_rawat=? order by pr.jam_rawat desc", TNoRw.getText()));
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            Valid.MyReportqry("rptCPPT.jasper", "report", "::[ Lembar Rawat Jalan ]::",
    ...
    }//GEN-LAST:event_cetak_cpptActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem cetak_cppt;
    ...
    private void isRawat(){
        ...
        Sequel.cariIsi("SELECT pl.nm_poli FROM reg_periksa rp LEFT JOIN poliklinik pl ON rp.kd_poli=pl.kd_poli WHERE rp.no_rawat=? ",TPoli,TNoRw.getText());
        TCariPasien.setText(TNoRM.getText());
    }
    ...
    private void tampilPemeriksaan() {
        ...
        try{  
            ps4=koneksi.prepareStatement("select pemeriksaan_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    ...
                    "pemeriksaan_ralan.berat,pemeriksaan_ralan.gcs,pemeriksaan_ralan.keluhan, " +
                    "pemeriksaan_ralan.pemeriksaan,pemeriksaan_ralan.alergi,pemeriksaan_ralan.imun_ke,"+
                    "pemeriksaan_ralan.rtl,pemeriksaan_ralan.penilaian,dokter.nm_dokter from pasien inner join reg_periksa inner join pemeriksaan_ralan inner join dokter "+
                    "on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter where  "+
...
//            userCPPT.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),19).toString());
